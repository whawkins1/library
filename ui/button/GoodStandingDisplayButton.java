...
public final class GoodStandingDisplayButton extends JButton{
    private static final long serialVersionUID = 1L;

    public GoodStandingDisplayButton(final JFrame aFrame) {
        super("Good");    
        addActionListener(new GoodStandingDisplayListener(aFrame));
        setVerticalTextPosition(JButton.BOTTOM);
        setHorizontalTextPosition(JButton.CENTER);
        try {
           Image image = ImageIO.read(getClass().getResource("/images/good.png"));
