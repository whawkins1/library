...
public final class PersonnelTable extends JTable {
    ...
    public PersonnelTable() {
        ...
        public final void setMouseListener(final PersonnelTable aTable, 
                                           final JComboBox<String> aCB, 
                                           final JFrame aFrame, 
                                           final DataHandler aHandler) {
            this.fCB = aCB;
            addMouseListener(new MouseListenerPersonnel(aTable, aCB, aFrame, aHandler));
        }
