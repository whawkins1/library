...
import ui.dialog.ReturnedAccountDialog;

public final class ReturnedDisplayListener 
                                implements ActionListener {
    private final DataHandler fHandler;
    private final JDialog fDialog;
    private final String fEmail;
    
    public ReturnedDisplayListener(final DataHandler aHandler, 
        ...
        @Override public final void actionPerformed(final ActionEvent event) {
            new ReturnedAccountDialog(fDialog, fHandler, fEmail);
        }
}